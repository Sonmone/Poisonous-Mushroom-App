...
def main(m_path, i_path):
    ...
    print("Poisonous: %f" % catness)
    print("Poisonous Mushroom Probability: %f" % (1 / (1 + np.exp(-catness))))
    print("It's a %s." % ("Poisonous Mushroom" if catness > 0 else "Edible Mushroom"))
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--path", type=str, default=os.path.join("images", "meidu.jpg"))
